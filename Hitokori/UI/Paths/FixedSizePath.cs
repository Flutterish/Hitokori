...
using osu.Game.Rulesets.Hitokori.Graphics;
using osuTK;
...
namespace osu.Game.Rulesets.Hitokori.UI.Paths {
	public partial class FixedSizePath : Drawable, IBufferedDrawableWithSizeConstraints {
		private Vector2 bufferSize = new Vector2( 400 );
		public Vector2 BufferSize {
			get => bufferSize;
			set {
				if ( bufferSize == value ) return;
		...
		public Vector2 MaximumFrameBufferSize => bufferSize;
		public bool AllowFrameBufferResizing => false;
        ...
        private readonly FixedSizeBufferedDrawNodeSharedData sharedData = new FixedSizeBufferedDrawNodeSharedData( new[] { RenderbufferInternalFormat.DepthComponent16 } );

        protected override DrawNode CreateDrawNode () => new FixedSizeBufferedDrawNode( this, new FixedSizePathDrawNode( this ), sharedData );
