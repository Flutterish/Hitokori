...
namespace osu.Game.Rulesets.Hitokori.UI.Paths {
	public partial class FixedSizePath {
        private class FixedSizePathDrawNode : DrawNode {
            public const int MAX_RES = 24;

            protected new FixedSizePath Source => (FixedSizePath)base.Source;
            ...
            public FixedSizePathDrawNode ( FixedSizePath source )
                : base( source ) {
            }
